<%@ Page Title="" Language="C#" MasterPageFile="~/GeneralLayout.Master" AutoEventWireup="true" CodeBehind="ForgotPass_AnswerSecQuestion.aspx.cs" Inherits="TechStore.ForgotPass_AnswerSecQuestion" %>
...
<div class="mainDiv">
  <div class="cardStyle">
    ...
    <div class="inputDiv">
        <asp:Label ID="Label3" CssClass="inputLabel" runat="server" Text="Enter Username"></asp:Label>
