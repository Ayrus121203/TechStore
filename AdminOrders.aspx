<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminOrders.aspx.cs" Inherits="TechStore.AdminOrders" %>
                        ...
                        <asp:Repeater ID="rptrOrders" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td><a href="AdminOrderDetails?InvoiceID=<%#Eval("InvoiceID") %>"><i class="fas fa-file-invoice-dollar"></i></a></td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
                    </tbody>
